...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "sidebar.openRepoRootTitle": "打开 Git checkout 内的目录以管理 worktree。",
    "sidebar.gitRepoRootOnly": "不在 Git checkout 中",
    "sidebar.gitRepoRootOnlyTitle": "只能在 Git checkout 内使用 worktree。",
    ...
    "sidebar.create": "创建",
    "sidebar.worktreeTargetUnavailable": "此 worktree 中对应的目录不可用。",
    "sidebar.missingWorktreeDirectory": "缺少相对目录：{path}",
    "sidebar.invalidWorktreeTarget": "对应目录无法安全使用。",
