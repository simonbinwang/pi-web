...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "sidebar.openRepoRoot": "Git checkout required",
    "sidebar.openRepoRootTitle": "Open a directory inside a Git checkout to manage worktrees.",
    "sidebar.gitRepoRootOnly": "Not a Git checkout",
    "sidebar.gitRepoRootOnlyTitle": "Worktrees are available inside Git checkouts.",
    ...
    "sidebar.worktreeTargetUnavailable": "The corresponding directory is unavailable in this worktree.",
    "sidebar.missingWorktreeDirectory": "Missing relative directory: {path}",
    "sidebar.invalidWorktreeTarget": "The corresponding directory is not safely available.",
