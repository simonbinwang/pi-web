...
export const zhTWLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "sidebar.open": "開啟",
    "sidebar.cancel": "取消",
    "sidebar.openRepoRoot": "需要 Git checkout",
    "sidebar.openRepoRootTitle": "開啟 Git checkout 內的目錄以管理 worktree。",
    "sidebar.gitRepoRootOnly": "不在 Git checkout 中",
    "sidebar.gitRepoRootOnlyTitle": "只能在 Git checkout 內使用 worktree。",
    ...
    "sidebar.create": "建立",
    "sidebar.worktreeTargetUnavailable": "此 worktree 中對應的目錄無法使用。",
    "sidebar.missingWorktreeDirectory": "缺少相對目錄：{path}",
    "sidebar.invalidWorktreeTarget": "對應目錄無法安全使用。",
